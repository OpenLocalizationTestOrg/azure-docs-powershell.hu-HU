---
title: "<span data-ttu-id=\"f1768-101\">Azure-erőforrások lekérdezése és az eredmények formázása | Microsoft Docs</span><span class=\"sxs-lookup\"><span data-stu-id=\"f1768-101\">Querying for Azure resources and formatting results | Microsoft Docs</span></span>"
description: "<span data-ttu-id=\"f1768-102\">Az erőforrások lekérdezése az Azure-ban, illetve az eredmények formázása.</span><span class=\"sxs-lookup\"><span data-stu-id=\"f1768-102\">How to query for resources in Azure and format the results.</span></span>"
services: azure
author: sdwheeler
ms.author: sewhee
manager: carmonm
...
---
# <span data-ttu-id="f1768-103">Azure-erőforrások lekérdezése</span><span class="sxs-lookup"><span data-stu-id="f1768-103">Querying for Azure resources</span></span>
...
## <span data-ttu-id="f1768-108">Egyszerű tulajdonságok kiválasztása</span><span class="sxs-lookup"><span data-stu-id="f1768-108">Selecting simple properties</span></span>
...
## <span data-ttu-id="f1768-115">Összetett beágyazott tulajdonságok kiválasztása</span><span class="sxs-lookup"><span data-stu-id="f1768-115">Selecting complex nested properties</span></span>
...
## <span data-ttu-id="f1768-118">Eredmények szűrése a Where-Object parancsmaggal</span><span class="sxs-lookup"><span data-stu-id="f1768-118">Filter result using the Where-Object cmdlet</span></span>
